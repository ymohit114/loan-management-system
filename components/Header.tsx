  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between h-16 px-4 md:px-8 bg-white/90 backdrop-blur-md border-b border-slate-200/80 no-print">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Currency Tag */}
        <div className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-semibold">
          <span>Currency:</span>
        ...
        {onOpenPaymentModal && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 sm:px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold shadow-sm transition-all active:scale-95 shrink-0"
          >
        ...
        <Link
          href="/loans/new"
          className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shadow-sm shadow-indigo-600/20 transition-all active:scale-95 shrink-0"
        >
